...
func TestEditTool_EditFile_Success(t *testing.T) {
	...
	tool := NewEditFileTool(tmpDir, nil, true)
...
func TestEditTool_EditFile_OutsideAllowedDir(t *testing.T) {
	...
	tool := NewEditFileTool(tmpDir, nil, true) // Restrict to tmpDir
	ctx := context.Background()
	args := map[string]interface{}{
		"path":     testFile,
		"old_text": "content",
...
func TestEditTool_EditFile_MissingPath(t *testing.T) {
	tool := NewEditFileTool("", nil, false)
	ctx := context.Background()
	args := map[string]interface{}{
		"old_text": "old",
		"new_text": "new",
...
func TestEditTool_AppendFile_Success(t *testing.T) {
	...
	tool := NewAppendFileTool("", nil, false)
	ctx := context.Background()
	args := map[string]interface{}{
		"path":    testFile,
		"content": "\nAppended content",
