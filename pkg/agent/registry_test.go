...
func (m *mockRegistryProvider) GetMaxTokens() int {
	return 8192
}

func (m *mockRegistryProvider) GetTemperature() float64 {
	return 0.7
}

func (m *mockRegistryProvider) GetMaxToolIterations() int {
	return 10
}

func (m *mockRegistryProvider) GetTimeout() int {
	return 120
}

func (m *mockRegistryProvider) GetMaxConcurrent() int {
	return 1
}
